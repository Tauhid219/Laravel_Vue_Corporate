                    ...
                    <div class="card-body">
                        ...
                        <!-- <form> -->
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" style="height: 100px" v-model="detail1"></textarea>
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" style="height: 150px" v-model="detail2"></textarea>
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" style="height: 150px" v-model="detail3"></textarea>
                                </div>
                            </div>
                            <div class="row mb-3">
